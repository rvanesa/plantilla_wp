                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="mdi mdi-cart"></i> <!-- Cambia mdi-format-page-break por mdi-cart -->
                                    <span>Carrito de Compras</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="pages-invoice.html">Lista de productos en el carrito</a></li>
                                    <li><a href="pages-starter.html">Funcionalidad de edición del carrito</a></li>
                                    <li><a href="pages-maintenance.html">Resumen del pedido</a></li>
                                </ul>
                            </li>
                                        ...
                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <img class="d-block img-fluid" src="img/carrusel3.jpg" alt="First slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="img/carrusel4.jpg" alt="Second slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="img/carrusel3.jpg" alt="Third slide">
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">
                                    desarrollado por RVPalomino                                </div>
                            </div>
                        </div>
                    </div>
                </footer>
